  ...
  reading "\n确定要卸载吗？【y/n】: " choice
    case "$choice" in
	  ...
	  sed -i '' '/export PATH="\$HOME\/bin:\$PATH"/d' ~/.bashrc
          ...
          purple "欢迎继续使用脚本：bash <(curl -Ls https://raw.githubusercontent.com/KUAILESHANGWEI/sing-box-yg/main/serv00.sh)"
          purple "************************************************************"
          ;;
        [Nn]) exit 0 ;;
...
FILE_INFO=("https://github.com/KUAILESHANGWEI/sing-box-yg/releases/download/serv00/sb web" "https://github.com/KUAILESHANGWEI/sing-box-yg/releases/download/serv00/server bot")
declare -A FILE_MAP
      ...
      "rule_set": [
            {
                ...
                "type": "remote",
                "format": "binary",
                "url": "https://github.com/KUAILESHANGWEI/sing-box-yg/releases/download/meta-rules-dat-srs/geosite-geolocation-not-cn.srs",
...
可应用在 https://github.com/KUAILESHANGWEI/sing-box-yg 项目中创建CF vless/trojan 节点
1、Proxyip(带端口)信息如下：
...
if [[ -e $WORKDIR/config.json ]]; then
  ...
  mkdir -p "$HOME/bin"
  curl -Ls https://raw.githubusercontent.com/KUAILESHANGWEI/sing-box-yg/main/serv00.sh > "$SCRIPT_PATH"
  chmod +x "$SCRIPT_PATH"
...
if [ "$hona" = "serv00" ]; then
curl -sL https://raw.githubusercontent.com/KUAILESHANGWEI/sing-box-yg/main/app.js -o "$keep_path"/app.js
...
curl -sSL https://raw.githubusercontent.com/KUAILESHANGWEI/sing-box-yg/main/serv00keep.sh -o serv00keep.sh && chmod +x serv00keep.sh
fi
curl -sL https://raw.githubusercontent.com/KUAILESHANGWEI/sing-box-yg/main/index.html -o "$FILE_PATH"/index.html
curl -sL https://raw.githubusercontent.com/KUAILESHANGWEI/sing-box-yg/main/sversion | awk -F "更新内容" '{print $1}' | head -n 1 > $WORKDIR/v
else
red "未安装脚本，请选择1进行安装" && exit
fi
}
...
menu() {
   clear
   echo "============================================================"
   green "甬哥Github项目  ：github.com/KUAILESHANGWEI"
...
latestV=$(curl -sL https://raw.githubusercontent.com/KUAILESHANGWEI/sing-box-yg/main/sversion | awk -F "更新内容" '{print $1}' | head -n 1)
if [ -f $WORKDIR/v ]; then
...
echo -e "${yellow}$(curl -sL https://raw.githubusercontent.com/KUAILESHANGWEI/sing-box-yg/main/sversion)${re}"
fi
echo -e "========================================================="
