...
latestV=$(curl -sL https://raw.githubusercontent.com/KUAILESHANGWEI/sing-box-yg/main/vendor/warp-version | awk -F "更新内容" '{print $1}' | head -n 1)
...
echo -e "${yellow}$(curl -sL https://raw.githubusercontent.com/KUAILESHANGWEI/sing-box-yg/main/vendor/warp-version)${plain}"
fi
else
...
lncf(){
curl -sSL -o /usr/bin/cf -L https://raw.githubusercontent.com/KUAILESHANGWEI/sing-box-yg/main/vendor/CFwarp.sh
chmod +x /usr/bin/cf
}
...
lncf
curl -sL https://raw.githubusercontent.com/KUAILESHANGWEI/sing-box-yg/main/vendor/warp-version | awk -F "更新内容" '{print $1}' | head -n 1 > /root/warpip/v
